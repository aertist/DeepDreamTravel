...
if __name__ == '__main__':
    ...
    parser.add_argument('--temp_dir', help='Temporary directory to store frames', type=str)
    ...
    parser.add_argument('--octave_scale', help='Resize amount per octave. Higher number leads to higher dream states', type=float)
